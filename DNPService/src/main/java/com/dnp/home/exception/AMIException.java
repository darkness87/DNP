...
public class AMIException extends Exception {
	...
	public AMIException(int faultCode) {
	...
	public AMIException(int faultCode, int messageCode) {
		super(PropertyMessage.getCodeMessage(messageCode));
		this.faultCode = Integer.toString(faultCode);
	}

	public AMIException(int faultCode, String msg) {
		super(msg);
		this.faultCode = Integer.toString(faultCode);
	}

	public AMIException(String faultCode, String msg) {
		super(msg);
		this.faultCode = faultCode;
	}
	// code와 message code가 동일 할경우
	public AMIException(int faultCode, Throwable cause) {
		super(PropertyMessage.getCodeMessage(faultCode), cause);
		this.faultCode = Integer.toString(faultCode);
	}
	// code가 일치하지 않으나, Property message를 그대로 사용할 경우 throwable 추가
	public AMIException(int faultCode, int messageCode, Throwable cause) {
		super(PropertyMessage.getCodeMessage(messageCode));
		this.faultCode = Integer.toString(faultCode);
	}

	public AMIException(String faultCode, String msg, Throwable cause) {
		super(msg, cause);
		this.faultCode = faultCode;
	}

	public AMIException(int faultCode, String msg, Throwable cause) {
		super(msg, cause);
		this.faultCode = Integer.toString(faultCode);
	}
